...
public class JSONArray implements List {
    ...
    public JSONArray(Collection collection) {
        ...
        if(collection != null) {
            ...
            while(iter.hasNext()) {
                this.myArrayList.add(JSONObject.wrap(iter.next(), new int[]{1}));
            }
        }

    }

    public JSONArray(Collection collection, int level) {
        this.myArrayList = new ArrayList();
        if(collection != null) {
            Iterator iter = collection.iterator();

            while(iter.hasNext()) {
                this.myArrayList.add(JSONObject.wrap(iter.next(), new int[]{level}));
            }
        }
    ...
    public JSONArray(Object array) throws JSONException {
        ...
        if(!array.getClass().isArray()) {
            ...
            for(int i = 0; i < length; ++i) {
                this.put(JSONObject.wrap(Array.get(array, i), new int[]{1}));
            }

        }
    }

    public JSONArray(Object array, int level) throws JSONException {
        this();
        if(!array.getClass().isArray()) {
            throw new JSONException("JSONArray initial value should be a string or collection or array.");
        } else {
            ...
            for(int i = 0; i < length; ++i) {
                this.put(JSONObject.wrap(Array.get(array, i), new int[]{level}));
            }
    ...
    public Object get(int index) {
        ...
        if(object == null) {
            E.S("JSONArray[" + index + "] not found.", new Object[0]);
        }
    ...
    public JSONArray put(Collection value) {
        this.put((Collection)(new JSONArray(value)));
        return this;
    }
    ...
    public JSONArray put(Map value) {
        this.put((Map)(new JSONObject(value, new int[0])));
        return this;
    }
    ...
    public JSONArray put(int index, Collection value) throws JSONException {
        this.put(index, (Collection)(new JSONArray(value)));
        return this;
    }
    ...
    public JSONArray put(int index, Map value) throws JSONException {
        this.put(index, (Map)(new JSONObject(value, new int[0])));
        return this;
    }
