...
public class Filter implements Serializable{
    ...
    public static Map<String, Filter> parse(Map<String, Object> searchParams) {
        return Filter.parse(searchParams, "search_");
    }
    /**
     * searchParams中key的格式为OPERATOR_FIELDNAME
     */
    public static Map<String, Filter> parse(Map<String, Object> searchParams,String prefix) {
        ...
        for (Map.Entry<String, Object> entry : searchParams.entrySet()) {
            ...
            Filter.Operator operator = Filter.Operator.valueOf(names[0].toLowerCase());
